        ...
        <div className="admin-layout">
            <aside className="admin-layout__sidebar">
                ...
                <nav className="admin-layout__nav">
                    ...
                    <NavLink to="/admin/cars" className={({ isActive }) => `admin-layout__link ${isActive ? 'admin-layout__link--active' : ''}`}>
                    ...
                    <NavLink to="/admin/customers" className={({ isActive }) => `admin-layout__link ${isActive ? 'admin-layout__link--active' : ''}`}>
                    ...
                    <NavLink to="/admin/sales" className={({ isActive }) => `admin-layout__link ${isActive ? 'admin-layout__link--active' : ''}`}>
                    ...
                    <NavLink to="/admin/invoices" className={({ isActive }) => `admin-layout__link ${isActive ? 'admin-layout__link--active' : ''}`}>
                    ...
                    <NavLink to="/admin/deposit-slips" className={({ isActive }) => `admin-layout__link ${isActive ? 'admin-layout__link--active' : ''}`}>
                    ...
                    <NavLink to="/admin/blogs" className={({ isActive }) => `admin-layout__link ${isActive ? 'admin-layout__link--active' : ''}`}>
                    ...
                    <NavLink to="/admin/enquiries" className={({ isActive }) => `admin-layout__link ${isActive ? 'admin-layout__link--active' : ''}`}>
                    ...
                    <NavLink to="/admin/general-expenses" className={({ isActive }) => `admin-layout__link ${isActive ? 'admin-layout__link--active' : ''}`}>
                    ...
                    <NavLink to="/admin/analytics" className={({ isActive }) => `admin-layout__link ${isActive ? 'admin-layout__link--active' : ''}`}>
                    ...
                    <NavLink to="/admin/settings" className={({ isActive }) => `admin-layout__link ${isActive ? 'admin-layout__link--active' : ''}`}>
                ...
                <div className="admin-layout__bottom">
                    <NavLink to="/" className="admin-layout__link">
                    ...
                    <button className="admin-layout__link admin-layout__link--danger" onClick={handleLogout}>
